        ...
        <div className='grid coxs:grid-cols-1 gap-6 lg:grid-cols-2 '>
          ...
          <div className="flex   coxs:flex-col  mb-5  md:items-center justify-between gap-10 text-white">
            <div className="max-w-[540px] 3xl:max-w-[700px]">
              ...
              <span className='text-[#f72d74] font-black'>Joomla </span>  Development Services
              </h1>
              <p className="text-[#e8e6e6] mt-5 mb-7 text-lg leading-8 font-Inter max-w-[637px]">
              We deliver top-grade, high-performing, and scalable Joomla-built 
              sites, apps, and portals with our proven methodologies and best-in-breed 
              tech stack. Having thrived startups, small businesses, and enterprises
               with our smart Joomla-based transformation, we are your authorized partner 
               for Joomla development services. From providing comprehensive consultancy 
               to Joomla-amateur organizations to offering expert improvement and maintenance 
               to Joomla-developed sites, we help conceptualize, develop, maintain, or deploy anything Joomla.
              </p>
