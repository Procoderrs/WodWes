        ...
        <div className='grid coxs:grid-cols-1 gap-6 lg:grid-cols-2 '>
          ...
          <div className="flex   coxs:flex-col  mb-5  md:items-center justify-between gap-10 text-white">
            <div className="max-w-[540px] 3xl:max-w-[700px]">
              ...
              <span className='text-[#f72d74] font-black'>Vue.Js</span>  Development Services 
              </h1>
              ...
              workflow across versatile platforms and devices. From single-page applications 
              to complex websites and CRMs, we deliver responsive, intuitive, and scalable web
               solutions, tailored to your user aesthetic taste, attracting growth opportunities,
                and establishing credibility throughout your industry. We combine our technical 
                skills with an extensive understanding of the Vue.js framework, creating business-oriented, 
              fast-build, and cost-effective Vue.js solutions with uncompromisable quality.
              </p>
