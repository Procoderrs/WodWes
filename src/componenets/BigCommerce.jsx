    ...
    {/* Grid Layout */}
      ...
      <div className=" ">
        <h1 className="text-3xl sm:text-4xl md:text-4xl lg:text-5xl md:leading-10 xl:text-6xl font-black">
          <span className="text-[#f72d74]">BigCommerce</span> Services
        </h1>
        <p className="text-[#e8e6e6] my-5 lg:my-11 text-lg leading-8 max-w-[500px] ">
        We are pleased to welcome you to the BigCommerce WODWES Services page!
         Our team of experts is here to provide you with top-notch services
          that will help you take your online business to the next level.
           Whether you need help with web design, development, or optimization, 
           we've got you covered. With our expertise in BigCommerce, 
           we can help you maximize your store's potential and achieve your business goals. Contact us 
        today to learn how we can help you grow your online business.
        </p>
        <Link
              to={"/"}
