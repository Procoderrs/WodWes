...
<div className="relative flex coxs:flex-col lg:flex-row items-center justify-end py-10 gap-10 w-[90%] mx-auto font-Inter">
  {/* Image Container */}
  <div className="order-1 flex items-center lg:w-[50%] justify-center">
    <img 
      src="./team.png" 
      className="rounded-md my-auto w-full lg:w-[500px] xl:w-[600px] 2xl:w-[700px] 3xl:w-[800px] coxs:w-[300px] maxlg:ml-[5.6%] maxlg:h-full" 
      alt="contact us"
    />
  </div>
  
  {/* Text Container */}
  <div className="relative z-10 lg:w-[50%] text-center lg:text-left">
    ...
    <p className="w-full text-[#e8e6e6] leading-9 lg:pl-4 xl:text-lg mt-4">
      The start of your next chapter is just one form submission away from reality.
    </p>
  </div>
</div>
  ...
  <div className='w-[90%] mx-auto max-w-[1440px] coxs:pb-32 lg:pt-16 coxs:pt-12 xl:pt-20'>
  <h2 className='text-left text-[#000000] coxs:text-2xl font-bold lg:text-3xl'>Contact Us</h2>
  <p className='mb-7 mt-4 w-full max-w-4xl text-left text-base font-normal text-[#272821]'>To contact us, simply fill out the form at the bottom of this page. To send us an RFP, RFI or other project specifications, email us at <span className='text-[#f72d74]'>info@wodwes.com</span></p>
  ...
  <div className="w-[90%] mx-auto max-w-[1440px] py-20">
  <div className="mx-auto -mt-[180px] h-full xs:w-5/6">
    ...
    <div className="mt-2 grid items-center   overflow-hidden rounded-[10px] bg-white shadow-[4px_4px_19px_0px_rgba(0,0,0,0.10)] lg:grid-cols-[300px_auto] xl:grid-cols-[400px_auto] 2xl:grid-cols-[500px_auto]">
      ...
      <div className="h-full">
        <img
          src="./address.png"
          className="h-full w-full maxxl:object-cover"
          alt="Office Location"
        />
      </div>
      ...
      <div className="w-full space-y-14 px-5 py-10 lg:pl-14">
        ...
        <div className="flex items-center gap-2">
          <img src="./location.svg" className="w-5 h-5" alt="Location Icon" />
          <div className="flex items-center gap-2">
            <h3 className="coxs:text-base font-bold leading-6 lg:text-xl whitespace-nowrap">
              Address:
            </h3>
            <address className="not-italic maxlg:text-sm">
              30N Gold ST, Sheridan, US
            </address>
          </div>
        </div>
        ...
        {/* Phone */}
        <div className="flex items-center gap-2">
          <img src="./phone.svg" className="w-5 h-5" alt="Phone Icon" />
          <div className="flex items-center gap-2">
            <h3 className="coxs:text-base font-bold leading-6 lg:text-xl whitespace-nowrap">
              Phone:
            </h3>
        ...
        {/* Email */}
        <div className="flex items-center gap-2">
          <img src="./email.svg" className="w-5 h-5" alt="Email Icon" />
          <div className="flex items-center gap-2">
            <h3 className="coxs:text-base font-bold leading-6 lg:text-xl whitespace-nowrap">
              Email:
            </h3>
...
<div className=' relative w-[90%] mx-auto max-w-[1440px] gap-10 z-10'>
...
<div className='col-span-2 flex flex-wrap justify-between gap-5 pt-5 sm:items-center maxsm:flex-col'>
  {/* Checkbox Section */}
  <label className='relative flex items-center gap-2 cursor-pointer text-sm leading-5 text-white'>
    <input 
      type="checkbox" 
      className='h-5 w-5 cursor-pointer  accent-[#f72d74] rounded-md border bg-transparent border-gray-500 checked:bg-[#f72d74] checked:border-[#f72d74] focus:outline-none' 
    />
  ...
  <div className='flex justify-center'>
    <button 
      type='submit' 
      className='bg-transparent text-white hover:bg-[#f72d74] hover:text-white flex w-[200px] items-center justify-center border-2 border-[#f72d74] py-3 px-5 font-semibold'>
