        ...
        <div className='grid coxs:grid-cols-1 gap-6 lg:grid-cols-2 '>
          ...
          <div className="flex   coxs:flex-col  mb-5  md:items-center justify-between gap-10 text-white">
            <div className="max-w-[540px] 3xl:max-w-[700px]">
              ...
              <span className='text-[#f72d74] font-black'>Magento </span>   Development Services 
              </h1>
              <p className="text-[#e8e6e6] mt-5 mb-7 text-lg leading-8 font-Inter max-w-[637px]">
              With seasoned expertise in creating Magento-based web experiences, WODWES offers 
              best-of-suite bespoke Magento development services. From creating Magento design and 
              architecture to deployment and optimization, our certified developers provide professional
               assistance in taking your business to the web. Leveraging our strategic innovation, and 
               nurtured Magento framework handling, we develop reliable, 
              scalable, and robust Magento e-commerce solutions to achieve desired business goals.
              </p>
