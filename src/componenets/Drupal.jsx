...
<div className="relative py-16 md:pb-32 md:pt-20 ">
  <img
    ...
    alt="Background"
  />
  <div className="relative w-[90%] mx-auto max-w-[1690px] text-white grid grid-cols-1 gap:10 lg:grid-cols-2 2xl:gap-40  ">
    {/* Grid Layout */}
    
      {/* Left Section */}
      <div className=" ">
        <h1 className="text-3xl sm:text-4xl md:text-4xl lg:text-5xl md:leading-10 xl:text-6xl font-black">
          <span className="text-[#f72d74]">Drupal</span> Website Development Services

        </h1>
        <p className="text-[#e8e6e6] my-5 lg:my-11 text-lg leading-8 max-w-[500px] ">
        We offer enterprise-grade Drupal development services that deliver robust and 
        end-to-end web, social, and mobile experiences. Our comprehensive Drupal framework 
        expertise, agile development methodology, and client-focused attitude helped leading 
        businesses boost their next-gen virtual transformation and growth. We offer flexible 
        engagement models that capitalize on radical CRM to deliver tangible business results 
        transparently.
      ...
      <div className="my-16 mx-auto max-w-[1440px]  z-10  overflow-hidden">
...
<ul className='flex flex-col gap-5 text-sm  mt-7 list-disc pl-5 pb-7 '>
