        ...
        <div className='grid coxs:grid-cols-1 gap-6 lg:grid-cols-2 '>
          ...
          <div className="flex   coxs:flex-col  mb-5  md:items-center justify-between gap-10 text-white">
            <div className="max-w-[540px] 3xl:max-w-[700px]">
              ...
              <span className='text-[#f72d74] font-black'>Angular</span>  Development Services 
              </h1>
              <p className="text-[#e8e6e6] mt-5 mb-7 text-lg leading-8 font-Inter max-w-[637px]">
              As an enterprise-grade Angular development company,
               we house a hybrid team with extensive domain expertise 
               and Angular framework integration capabilities to develop 
               tailor-built, highly functional, and ready-to-market web solutions. 
               Our detail-oriented developers deeply analyze your business 
               to devise the right blend of front-end and back-end development technologies, 
               delivering intuitive and business-transforming Angular web solutions. 
               Fast-paced, interactive applications are our trademark, bringing unparalleled user 
              experience, and claiming your share of online success.
              </p>
