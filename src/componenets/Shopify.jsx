...
<div className="relative w-full py-12 lg:py-20">
     ...
     <button type='submit' className='flex items-center justify-center gap-4 w-full p-4 text-sm font-semibold bg-[#f72d74]  text-white'>
      ...
      <p className='mb-7 leading-9 '>WODWES is an experienced and professional 
    ...
    <h3 className='text-xl font-bold'>Shopify Development Solutions</h3>
...
<ul className='flex coxs:flex-col gap-5 list-disc pl-5 '>
  ...
  <li>Shopify POS Development</li>
    ...
    <div className='flex items-center gap-5'>
    <img src="/grid-img.png" alt="grid-img" className='h-9 w-9' />
    <h3 className='text-xl font-bold'>Shopify Integration Solutions</h3>
...
<ul className='flex coxs:flex-col gap-5 list-disc pl-5 '>
  ...
  <li>Payment Gateway Integration</li>
    ...
    <div className='flex items-center gap-5'>
    <img src="/grid-img.png" alt="grid-img" className='h-9 w-9' />
    <h3 className='text-xl font-bold'>Shopify Migration Support</h3>
